...
declare const QUICKCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof QUICKCODE_LIBC === "undefined" ? undefined : QUICKCODE_LIBC
...
const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.QUICKCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.QUICKCODE_EXPERIMENTAL_FILEWATCHER)) {
