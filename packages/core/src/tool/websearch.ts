...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.QUICKCODE_WEBSEARCH_PROVIDER === "exa" || process.env.QUICKCODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.QUICKCODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("QUICKCODE_EXPERIMENTAL") || truthy("QUICKCODE_ENABLE_EXA") || truthy("QUICKCODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("QUICKCODE_ENABLE_PARALLEL") || truthy("QUICKCODE_EXPERIMENTAL_PARALLEL"),
