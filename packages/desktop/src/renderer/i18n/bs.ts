export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju QuickCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} QuickCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
