export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av QuickCode har laddats ned. Vill du installera den och starta om programmet?",
