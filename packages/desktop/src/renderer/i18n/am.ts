export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የQuickCode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከQuickCode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
