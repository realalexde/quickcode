export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van QuickCode is gedownload. Wil je deze installeren en QuickCode opnieuw starten?",
