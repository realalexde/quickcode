export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} QuickCode a fost descărcată. Vrei să o instalezi și să repornești?",
