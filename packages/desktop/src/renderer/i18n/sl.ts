export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} QuickCode je bila prenesena, jo želite namestiti in znova zagnati?",
