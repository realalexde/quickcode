export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią QuickCode versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "QuickCode versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
