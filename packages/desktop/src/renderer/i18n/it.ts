export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di QuickCode è stata scaricata. Vuoi installarla e riavviare l'app?",
