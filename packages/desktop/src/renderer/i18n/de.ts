export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von QuickCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
