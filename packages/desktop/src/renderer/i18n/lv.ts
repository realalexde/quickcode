export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko QuickCode versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "QuickCode versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
