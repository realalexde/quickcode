export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք QuickCode-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "QuickCode-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
