export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} QuickCode telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
