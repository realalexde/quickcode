export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af QuickCode er blevet downloadet. Vil du installere den og genstarte?",
