export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije QuickCode. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
