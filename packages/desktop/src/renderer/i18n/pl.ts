export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} QuickCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
