export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av QuickCode.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av QuickCode er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
