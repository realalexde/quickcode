export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от QuickCode е изтеглена. Искате ли да я инсталирате и рестартирате?",
