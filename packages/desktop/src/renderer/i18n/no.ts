export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av QuickCode er lastet ned. Vil du installere den og starte på nytt?",
