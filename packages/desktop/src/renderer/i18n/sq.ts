export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i QuickCode është shkarkuar, dëshironi ta instaloni dhe rinisni?",
