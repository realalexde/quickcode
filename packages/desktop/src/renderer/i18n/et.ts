export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse QuickCode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "QuickCode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
