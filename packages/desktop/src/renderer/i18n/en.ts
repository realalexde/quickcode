export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of QuickCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of QuickCode has been downloaded, would you like to install it and relaunch?",
