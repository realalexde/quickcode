export const dict = {
  ...
  "desktop.recovery.loadFailed": "QuickCode yüklənə bilmədi",
  "desktop.recovery.terminated": "QuickCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "QuickCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.quickcodeMissing": "Bu distribütivdə opencode quraşdırılmayıb",
  "desktop.wsl.error.quickcodeCannotRun": "opencode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "QuickCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.quickcode.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.quickcodeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "QuickCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və QuickCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və QuickCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və QuickCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər quickcode.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu QuickCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də QuickCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "QuickCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də QuickCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də QuickCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "QuickCode-u yeniləyin",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode {{distro}}-də hazırdır.",
  "wsl.onboarding.quickcodeReady": "QuickCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "QuickCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "QuickCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QuickCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "QuickCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra QuickCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "QuickCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QuickCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı QuickCode komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (quickcode.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: QuickCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində QuickCode serverini işlət.",
  ...
  "settings.general.row.language.description": "QuickCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "QuickCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "QuickCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "QuickCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "QuickCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "QuickCode-un ən son versiyasından istifadə edirsiniz.",
