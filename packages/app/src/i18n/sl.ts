export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "QuickCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno QuickCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "QuickCode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev QuickCode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.quickcodeMissing": "opencode ni nameščen v tej distribuciji",
  "desktop.wsl.error.quickcodeCannotRun": "opencode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev QuickCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.quickcode.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.quickcodeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Obisk ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v QuickCode.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v quickcode.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom QuickCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje QuickCode ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje QuickCode v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje QuickCode ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje QuickCode v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite QuickCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode je pripravljen v {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite QuickCode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko QuickCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "QuickCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica QuickCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi QuickCode",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (quickcode.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, QuickCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik QuickCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za QuickCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako QuickCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali QuickCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo QuickCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene QuickCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico QuickCode.",
