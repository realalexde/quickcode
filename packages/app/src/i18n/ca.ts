export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú QuickCode.",
  ...
  "desktop.recovery.loadFailed": "QuickCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra QuickCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "QuickCode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de QuickCode ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.quickcodeMissing": "opencode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.quickcodeCannotRun": "opencode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QuickCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.quickcode.tagline": "Models optimitzats fiables",
  "dialog.provider.quickcodeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.quickcodeZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a QuickCode.",
  ...
  "dialog.plugins.empty": "Connectors configurats a quickcode.json",
  ...
  "dialog.server.description": "Canvia a quin QuickCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant QuickCode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant QuickCode a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza QuickCode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode està llest a {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu QuickCode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que QuickCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "QuickCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de QuickCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip QuickCode.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (quickcode.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que QuickCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "QuickCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor QuickCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a QuickCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu QuickCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si QuickCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de QuickCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï QuickCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de QuickCode.",
