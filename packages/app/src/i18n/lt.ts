...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "QuickCode įkelti nepavyko",
  "QuickCode langas netikėtai užsidarė",
  "QuickCode neatsako",
  ...
  "QuickCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "QuickCode neįdiegtas distributyve {{distro}}",
  "QuickCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.quickcode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.quickcode.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.quickcodeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami QuickCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.quickcodeZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.quickcodeZen.visit.prefix": "Aplankykite",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius QuickCode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti quickcode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio QuickCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama QuickCode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas QuickCode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite QuickCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode yra paruoštas {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite QuickCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad QuickCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "QuickCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują QuickCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą QuickCode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (quickcode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad QuickCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "QuickCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "QuickCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite QuickCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite QuickCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip QuickCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar QuickCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite QuickCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas QuickCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią QuickCode versiją.",
