export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do QuickCode",
  ...
  "desktop.menu.ariaLabel": "Menu do QuickCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o QuickCode",
  "desktop.recovery.terminated": "A janela do QuickCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O QuickCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do QuickCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.quickcodeMissing": "O opencode não está instalado nesta distribuição",
  "desktop.wsl.error.quickcodeCannotRun": "O opencode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.quickcodeNotInstalled": "O QuickCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do QuickCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.quickcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.quickcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Visite ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no QuickCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em quickcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor QuickCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o QuickCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o QuickCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o QuickCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "O QuickCode está pronto em {{distro}}.",
  "wsl.onboarding.quickcodeReady": "O QuickCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o QuickCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o QuickCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O QuickCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o QuickCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o QuickCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do QuickCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do QuickCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (quickcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: QuickCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor QuickCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do QuickCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o QuickCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o QuickCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o QuickCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o QuickCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do QuickCode.",
