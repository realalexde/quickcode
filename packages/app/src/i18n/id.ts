export const dict = {
  ...
  "desktop.recovery.loadFailed": "QuickCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela QuickCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "QuickCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi QuickCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.quickcodeMissing": "opencode belum terinstal di distro ini",
  "desktop.wsl.error.quickcodeCannotRun": "opencode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan QuickCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.quickcode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.quickcodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di QuickCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di quickcode.json",
  ...
  "dialog.server.description": "Ganti server QuickCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa QuickCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui QuickCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui QuickCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode siap di {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal QuickCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum QuickCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "QuickCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru QuickCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim QuickCode",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (quickcode.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: QuickCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server QuickCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk QuickCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan QuickCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah QuickCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat QuickCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru QuickCode.",
