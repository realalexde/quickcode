export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "QuickCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het QuickCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "QuickCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van QuickCode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.quickcodeMissing": "opencode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.quickcodeCannotRun": "opencode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De QuickCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.quickcode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.quickcodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in QuickCode te gebruiken.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.quickcodeZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.quickcodeZen.visit.prefix": "Ga naar ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in QuickCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in QuickCode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in quickcode.json",
  ...
  "dialog.server.description": "Wijzig met welke QuickCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "QuickCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "QuickCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "QuickCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk QuickCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "QuickCode bijwerken",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode is gereed in {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer QuickCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat QuickCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "QuickCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens QuickCode opnieuw.",
  ...
  "help.tabs.introduction": "QuickCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van QuickCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het QuickCode-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (quickcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: QuickCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de QuickCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor QuickCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe QuickCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of QuickCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van QuickCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer QuickCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "QuickCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van QuickCode.",
