...
const desktop = [
  ...
  "Kilépés",
  "Az QuickCode betöltése sikertelen",
  "Az QuickCode ablaka váratlanul leállt",
  "Az QuickCode nem válaszol",
  ...
  "Az QuickCode telepítése sikertelen",
  ...
  "Az QuickCode nincs telepítve ebben: {{distro}}",
  "Az QuickCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.quickcode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.quickcode.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.quickcodeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A QuickCode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a QuickCode-ben.",
  ...
  "provider.connect.quickcodeZen.line1":
    "A QuickCode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Látogatás",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a QuickCode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a QuickCode-ben.",
  ...
  "dialog.plugins.empty": "Az quickcode.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik QuickCode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "QuickCode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "QuickCode frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "QuickCode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a QuickCode-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a QuickCode-t",
  "wsl.onboarding.quickcodeReadyIn": "A QuickCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.quickcodeReady": "A QuickCode készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a QuickCode-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a QuickCode-t",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "A QuickCode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a QuickCode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A QuickCode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a QuickCode programot.",
  ...
  "help.tabs.introduction": "A QuickCode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A QuickCode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a QuickCode csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (quickcode.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a QuickCode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A QuickCode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "QuickCode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a QuickCode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a QuickCode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a QuickCode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a QuickCode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a QuickCode témáját.",
  ...
  "settings.updates.row.startup.description": "A QuickCode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a QuickCode legújabb verzióját futtatja.",
