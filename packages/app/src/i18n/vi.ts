export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu QuickCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được QuickCode",
  "desktop.recovery.terminated": "Cửa sổ QuickCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "QuickCode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được QuickCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.quickcodeMissing": "opencode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.quickcodeCannotRun": "opencode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật QuickCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.quickcode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.quickcodeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do QuickCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Truy cập ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong QuickCode.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong quickcode.json",
  ...
  "dialog.server.description": "Chuyển máy chủ QuickCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra QuickCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật QuickCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật QuickCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt QuickCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi QuickCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "QuickCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của QuickCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm QuickCode",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (quickcode.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: QuickCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ QuickCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho QuickCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của QuickCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem QuickCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của QuickCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi QuickCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của QuickCode.",
