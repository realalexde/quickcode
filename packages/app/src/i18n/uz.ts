export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "QuickCode menyusi",
  ...
  "desktop.recovery.loadFailed": "QuickCode yuklanmadi",
  "desktop.recovery.terminated": "QuickCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "QuickCode javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.quickcodeMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.quickcodeCannotRun": "opencode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "QuickCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.quickcode.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.quickcodeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "QuickCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va QuickCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va QuickCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va QuickCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "quickcode.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi QuickCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "QuickCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "QuickCode yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "QuickCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "QuickCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "QuickCode-ni yangilang",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode {{distro}} da tayyor.",
  "wsl.onboarding.quickcodeReady": "QuickCode tayyor.",
  "wsl.onboarding.installOpencodeIn": "QuickCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "QuickCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QuickCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "QuickCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra QuickCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "QuickCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QuickCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida QuickCode jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (quickcode.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, QuickCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "QuickCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi QuickCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "QuickCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "QuickCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "QuickCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "QuickCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "QuickCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz QuickCode oxirgi versiyasini ishga tushiryapsiz.",
