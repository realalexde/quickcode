export const dict = {
  ...
  "desktop.menu.documentation": "Documentație QuickCode",
  ...
  "desktop.menu.ariaLabel": "Meniu QuickCode",
  ...
  "desktop.recovery.loadFailed": "QuickCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra QuickCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "QuickCode nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea QuickCode a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.quickcodeMissing": "opencode nu este instalat în această distribuție",
  "desktop.wsl.error.quickcodeCannotRun": "opencode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea QuickCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.quickcode.tagline": "Modele optimizate, fiabile",
  "dialog.provider.quickcodeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.quickcodeZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.quickcodeZen.visit.prefix": "Vizitează",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în QuickCode.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în quickcode.json",
  ...
  "dialog.server.description": "Schimbă serverul QuickCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică QuickCode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează QuickCode în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează QuickCode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode este gata în {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează QuickCode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca QuickCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "QuickCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune QuickCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei QuickCode",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (quickcode.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, QuickCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul QuickCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru QuickCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul QuickCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă QuickCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema QuickCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea QuickCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune QuickCode.",
