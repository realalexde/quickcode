export const dict = {
  ...
  "desktop.recovery.loadFailed": "QuickCodeを読み込めませんでした",
  "desktop.recovery.terminated": "QuickCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "QuickCodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "QuickCodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.quickcodeMissing": "このディストリビューションにはopencodeがインストールされていません",
  "desktop.wsl.error.quickcodeCannotRun": "opencodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.quickcodeNotInstalled": "{{distro}}にはQuickCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "QuickCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.quickcode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.quickcode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.quickcodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "QuickCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、QuickCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.quickcodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.quickcodeZen.visit.prefix": " ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してQuickCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、QuickCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "quickcode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するQuickCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のQuickCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "QuickCodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のQuickCodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のQuickCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "QuickCodeを更新",
  "wsl.onboarding.quickcodeReadyIn": "{{distro}}内のQuickCodeの準備ができました。",
  "wsl.onboarding.quickcodeReady": "QuickCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にQuickCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "QuickCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QuickCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、QuickCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "QuickCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QuickCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをQuickCodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (quickcode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: QuickCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "QuickCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でQuickCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "QuickCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのQuickCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "QuickCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "QuickCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "QuickCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "QuickCode は最新バージョンです。",
