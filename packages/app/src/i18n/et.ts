export const dict = {
  ...
  "desktop.recovery.loadFailed": "QuickCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "QuickCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "QuickCode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.quickcodeMissing": "opencode pole sellesse distrosse installitud",
  "desktop.wsl.error.quickcodeCannotRun": "opencode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QuickCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.quickcode.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.quickcodeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid QuickCode'is.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Külastage ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises QuickCode.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis quickcode.json",
  ...
  "dialog.server.description": "Lülitage, millise QuickCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "QuickCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "QuickCode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "QuickCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda QuickCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode on valmis {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige QuickCode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui QuickCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "QuickCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse QuickCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast QuickCode meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (quickcode.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, QuickCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "QuickCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage QuickCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke QuickCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas QuickCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas QuickCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas QuickCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui QuickCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse QuickCode uusimat versiooni.",
