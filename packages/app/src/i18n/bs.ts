export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za QuickCode",
  ...
  "desktop.menu.ariaLabel": "QuickCode meni",
  ...
  "desktop.recovery.loadFailed": "QuickCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor QuickCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "QuickCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija QuickCode-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.quickcodeMissing": "opencode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.quickcodeCannotRun": "opencode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje QuickCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.quickcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.quickcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u QuickCode-u.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u QuickCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u QuickCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u quickcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se QuickCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera QuickCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje QuickCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj QuickCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj QuickCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi QuickCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "QuickCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija QuickCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku QuickCode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (quickcode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: QuickCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni QuickCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u QuickCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako QuickCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li QuickCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu QuickCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se QuickCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju QuickCode-a.",
