export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "QuickCode مینو",
  ...
  "desktop.recovery.loadFailed": "QuickCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "QuickCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "QuickCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.quickcodeMissing": "اس ڈسٹری بیوشن میں opencode انسٹال نہیں ہے",
  "desktop.wsl.error.quickcodeCannotRun": "opencode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.quickcodeNotInstalled": "{{distro}} میں QuickCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "QuickCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.quickcode.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.quickcode.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.quickcodeGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "QuickCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور QuickCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور QuickCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور QuickCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "quickcode.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس QuickCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں QuickCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "QuickCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں QuickCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں QuickCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "QuickCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.quickcodeReady": "QuickCode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں QuickCode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "QuickCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ QuickCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "QuickCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر QuickCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "QuickCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QuickCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم QuickCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (quickcode.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، QuickCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "QuickCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "QuickCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر QuickCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "QuickCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر QuickCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا QuickCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "QuickCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "QuickCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ QuickCode کا تازہ ترین ورژن چلا رہے ہیں۔",
