export const dict = {
  ...
  "dialog.provider.quickcode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.quickcode.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.quickcodeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Avaa ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " ja hae API-avaimesi.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään quickcode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda QuickCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.updateOpencodeIn": "Päivitä QuickCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna QuickCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "OpenCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin QuickCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "QuickCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten QuickCode uudelleen.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä QuickCode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (quickcode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että QuickCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita QuickCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä QuickCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö QuickCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun QuickCode käynnistyy",
  ...
  "desktop.menu.documentation": "QuickCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "QuickCode-valikko",
  ...
  "desktop.recovery.terminated": "QuickCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "QuickCode ei vastaa",
  ...
  "desktop.wsl.error.quickcodeMissing": "opencodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.quickcodeCannotRun": "opencode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.quickcodeNotInstalled": "OpenCodea ei ole asennettu jakeluun {{distro}}",
  ...
  "help.tabs.introduction": "QuickCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
