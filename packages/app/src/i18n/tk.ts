export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "QuickCode menýusy",
  ...
  "desktop.recovery.loadFailed": "QuickCode ýükläp bilmedi",
  "desktop.recovery.terminated": "QuickCode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "QuickCode jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.quickcodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.quickcodeCannotRun": "opencode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "QuickCode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.quickcode.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.quickcodeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "QuickCode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we QuickCode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Sapar ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini QuickCode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini QuickCode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "quickcode.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy QuickCode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde QuickCode barlanýar...",
  "wsl.onboarding.updatingOpencode": "QuickCode täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de QuickCode täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "QuickCode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "QuickCode täzeläň",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode {{distro}}-de taýýar.",
  "wsl.onboarding.quickcodeReady": "QuickCode taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de QuickCode guruň.",
  "wsl.onboarding.installOpencode": "QuickCode guruň",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) QuickCode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "QuickCode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra QuickCode açyň.",
  ...
  "help.tabs.introduction": "QuickCode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin QuickCode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy QuickCode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (quickcode.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, QuickCode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "QuickCode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "QuickCode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "QuickCode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "QuickCode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "QuickCode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "QuickCode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "QuickCode-iň iň soňky wersiýasyny işleýärsiňiz.",
