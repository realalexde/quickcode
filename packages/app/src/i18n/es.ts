export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de QuickCode",
  ...
  "desktop.menu.ariaLabel": "Menú de QuickCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar QuickCode",
  "desktop.recovery.terminated": "La ventana de QuickCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "QuickCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar QuickCode",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.quickcodeMissing": "opencode no está instalado en esta distribución",
  "desktop.wsl.error.quickcodeCannotRun": "opencode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de QuickCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.quickcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.quickcodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.quickcodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en QuickCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en quickcode.json",
  ...
  "dialog.server.description": "Cambiar el servidor de QuickCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando QuickCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando QuickCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza QuickCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode está listo en {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala QuickCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que QuickCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "QuickCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de QuickCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de QuickCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (quickcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: QuickCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor QuickCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para QuickCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve QuickCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si QuickCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de QuickCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia QuickCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de QuickCode.",
