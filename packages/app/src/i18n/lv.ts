export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode dokumentācija",
  ...
  "desktop.menu.ariaLabel": "QuickCode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt QuickCode",
  "desktop.recovery.terminated": "QuickCode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "QuickCode neatbild",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.quickcodeMissing": "opencode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.quickcodeCannotRun": "opencode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QuickCode atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.quickcode.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.quickcodeGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus QuickCode.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti quickcode.json",
  ...
  "dialog.server.description": "Mainiet, pie kura QuickCode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu QuickCode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu QuickCode distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet QuickCode distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet QuickCode distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms QuickCode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "QuickCode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet QuickCode no jauna.",
  ...
  "help.tabs.introduction": "QuickCode Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna QuickCode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu QuickCode komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (quickcode.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, QuickCode vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "QuickCode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist QuickCode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt QuickCode saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā QuickCode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai QuickCode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet QuickCode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot QuickCode",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko QuickCode versiju.",
