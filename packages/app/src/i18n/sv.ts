export const dict = {
  ...
  "desktop.recovery.loadFailed": "QuickCode kunde inte läsas in",
  "desktop.recovery.terminated": "QuickCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "QuickCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av QuickCode misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.quickcodeMissing": "opencode är inte installerat i den här distributionen",
  "desktop.wsl.error.quickcodeCannotRun": "opencode är installerat men kunde inte köras",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QuickCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.quickcode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.quickcode.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.quickcodeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Besök ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i QuickCode.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i quickcode.json",
  ...
  "dialog.server.description": "Växla vilken QuickCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar QuickCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar QuickCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera QuickCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode är redo i {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera QuickCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan QuickCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "QuickCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan QuickCode igen.",
  ...
  "help.tabs.introduction": "QuickCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av QuickCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till QuickCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (quickcode.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, QuickCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör QuickCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för QuickCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur QuickCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om QuickCode följer system-, ljus- eller mörktemat",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när QuickCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av QuickCode.",
