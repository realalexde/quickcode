export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل QuickCode",
  "desktop.recovery.terminated": "توقفت نافذة QuickCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "QuickCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت QuickCode",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.quickcodeMissing": "opencode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.quickcodeCannotRun": "opencode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث QuickCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.quickcode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.quickcode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.quickcodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من QuickCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "يمنحك QuickCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في QuickCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في quickcode.json",
  ...
  "dialog.server.description": "تبديل خادم QuickCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من QuickCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث QuickCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث QuickCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode جاهز في {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت QuickCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن QuickCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على QuickCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح QuickCode.",
  ...
  "help.tabs.introduction": "أصبح QuickCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من QuickCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق QuickCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (quickcode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن QuickCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن QuickCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم QuickCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ QuickCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور QuickCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان QuickCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة QuickCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل QuickCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من QuickCode.",
