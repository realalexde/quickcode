export const dict = {
  ...
  "dialog.provider.quickcode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.quickcode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.quickcodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.quickcodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.quickcodeZen.visit.prefix": "Besøg ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i QuickCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i quickcode.json",
  ...
  "dialog.server.description": "Skift hvilken QuickCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker QuickCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer QuickCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater QuickCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før QuickCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "QuickCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter QuickCode igen.",
  ...
  "toast.update.description": "En ny version af QuickCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til QuickCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (quickcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, QuickCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør QuickCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for QuickCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan QuickCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om QuickCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når QuickCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af QuickCode.",
  ...
  "desktop.recovery.loadFailed": "QuickCode kunne ikke indlæses",
  "desktop.recovery.terminated": "QuickCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af QuickCode mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.quickcodeMissing": "opencode er ikke installeret i denne distribution",
  "desktop.wsl.error.quickcodeCannotRun": "opencode er installeret, men kunne ikke køre",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af QuickCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "QuickCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
