...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða QuickCode",
  "QuickCode-glugganum var óvænt lokað",
  "QuickCode svarar ekki",
  ...
  "QuickCode er ekki uppsett í {{distro}}",
  "Uppfærslu QuickCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.quickcode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.quickcode.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.quickcodeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.quickcodeZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.quickcodeZen.visit.prefix": "Heimsókn",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í QuickCode.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í quickcode.json",
  ...
  "dialog.server.description": "Skiptu um hvaða QuickCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar QuickCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir QuickCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu QuickCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode er tilbúið í {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp QuickCode í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en QuickCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "QuickCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan QuickCode aftur.",
  ...
  "help.tabs.introduction": "QuickCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af QuickCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til QuickCode teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (quickcode.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, QuickCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "QuickCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "QuickCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu QuickCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir QuickCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig QuickCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort QuickCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig QuickCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar QuickCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af QuickCode.",
