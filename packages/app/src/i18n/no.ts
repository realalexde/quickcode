...
export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "QuickCode-meny",
  ...
  "desktop.recovery.loadFailed": "QuickCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "QuickCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "QuickCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av QuickCode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.quickcodeMissing": "opencode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.quickcodeCannotRun": "opencode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av QuickCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.quickcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.quickcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Besøk ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i QuickCode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i quickcode.json",
  ...
  "dialog.server.description": "Bytt hvilken QuickCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av QuickCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til QuickCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (quickcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at QuickCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør QuickCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for QuickCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan QuickCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om QuickCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i QuickCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når QuickCode starter",
  ...
  "settings.updates.toast.latest.title": "QuickCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av QuickCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker QuickCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer QuickCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater QuickCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode er klar i {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer QuickCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før QuickCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "QuickCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter QuickCode på nytt.",
  ...
  "help.tabs.introduction": "QuickCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
