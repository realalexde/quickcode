...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "QuickCode failed to load",
  "desktop.recovery.terminated": "QuickCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "QuickCode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.quickcodeMissing": "opencode is not installed in this distro",
  "desktop.wsl.error.quickcodeCannotRun": "opencode is installed but could not run",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QuickCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
