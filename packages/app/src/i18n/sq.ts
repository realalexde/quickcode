export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni QuickCode",
  ...
  "desktop.menu.ariaLabel": "Menuja QuickCode",
  ...
  "desktop.recovery.loadFailed": "QuickCode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja QuickCode u mbyll papritur",
  "desktop.recovery.unresponsive": "QuickCode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i QuickCode dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.quickcodeMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.quickcodeCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i QuickCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.quickcode.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.quickcodeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në QuickCode.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në quickcode.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server QuickCode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon QuickCode në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "QuickCode po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson QuickCode në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso QuickCode në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode është gati në {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni QuickCode në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se QuickCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "QuickCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i QuickCode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i QuickCode",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (quickcode.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, QuickCode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin QuickCode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për QuickCode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket QuickCode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse QuickCode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e QuickCode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset QuickCode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të QuickCode.",
