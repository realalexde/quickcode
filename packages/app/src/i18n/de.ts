...
export const dict = {
  ...
  "dialog.provider.quickcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.quickcode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.quickcodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in QuickCode zu nutzen.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.quickcodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.quickcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in QuickCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in QuickCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In quickcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den QuickCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.quickcode": "QuickCode",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "QuickCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "QuickCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "QuickCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie QuickCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "QuickCode aktualisieren",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode ist in {{distro}} bereit.",
  "wsl.onboarding.quickcodeReady": "QuickCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie QuickCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "QuickCode installieren",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor QuickCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "QuickCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann QuickCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von QuickCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem QuickCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (quickcode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: QuickCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "QuickCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "QuickCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "QuickCode Desktop",
  ...
  "settings.desktop.wsl.description": "QuickCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für QuickCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie QuickCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob QuickCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von QuickCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von QuickCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "QuickCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von QuickCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "QuickCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das QuickCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "QuickCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.quickcodeMissing": "opencode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.quickcodeCannotRun": "opencode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das QuickCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "QuickCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
