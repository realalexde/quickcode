export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "QuickCode մենյու",
  ...
  "desktop.recovery.loadFailed": "QuickCode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "QuickCode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "QuickCode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.quickcodeMissing": "opencode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.quickcodeCannotRun": "opencode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QuickCode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.quickcode.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.quickcodeGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և QuickCode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Այցելություն ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և QuickCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և QuickCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են quickcode.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ QuickCode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է QuickCode-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է QuickCode-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել QuickCode-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.quickcodeReady": "QuickCode պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք QuickCode-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի QuickCode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "QuickCode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք QuickCode։",
  ...
  "help.tabs.introduction": "QuickCode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QuickCode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին QuickCode թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (quickcode.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ QuickCode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "QuickCode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք QuickCode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն QuickCode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է QuickCode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ QuickCode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է QuickCode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ QuickCode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք QuickCode-ի վերջին տարբերակը։",
