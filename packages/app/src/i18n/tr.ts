...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "QuickCode yüklenemedi",
  "desktop.recovery.terminated": "QuickCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "QuickCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.quickcodeMissing": "opencode bu dağıtımda kurulu değil",
  "desktop.wsl.error.quickcodeCannotRun": "opencode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "QuickCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.quickcode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.quickcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "QuickCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve QuickCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.quickcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak QuickCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak QuickCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler quickcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi QuickCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde QuickCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "QuickCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde QuickCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki QuickCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "QuickCode'u güncelle",
  "wsl.onboarding.quickcodeReadyIn": "{{distro}} içinde QuickCode hazır.",
  "wsl.onboarding.quickcodeReady": "QuickCode hazır.",
  "wsl.onboarding.installOpencodeIn": "QuickCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "QuickCode'u kur",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QuickCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "QuickCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından QuickCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "QuickCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QuickCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı QuickCode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (quickcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: QuickCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "QuickCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "QuickCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "QuickCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "QuickCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "QuickCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "QuickCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "QuickCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "QuickCode'un en son sürümünü kullanıyorsunuz.",
