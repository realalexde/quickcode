export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode Skjøl",
  ...
  "desktop.menu.ariaLabel": "QuickCode valmynd",
  ...
  "desktop.recovery.loadFailed": "QuickCode miseydnaðist at heinta",
  "desktop.recovery.terminated": "QuickCode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "QuickCode svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.quickcodeMissing": "opencode er ikki sett upp í hesi distro",
  "desktop.wsl.error.quickcodeCannotRun": "opencode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QuickCode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.quickcode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.quickcode.tagline": "Álítandi optimerað modell",
  "dialog.provider.quickcodeGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.quickcodeZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.quickcodeZen.visit.prefix": "Vitja ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í QuickCode.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í quickcode.json",
  ...
  "dialog.server.description": "Skift hvønn QuickCode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna QuickCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring QuickCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør QuickCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode er klárt í {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set QuickCode upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn QuickCode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "QuickCode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani QuickCode aftur.",
  ...
  "help.tabs.introduction": "QuickCode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av QuickCode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til QuickCode toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (quickcode.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, QuickCode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "QuickCode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr QuickCode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri QuickCode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu QuickCode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um QuickCode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu QuickCode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá QuickCode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av QuickCode.",
