export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka QuickCode",
  ...
  "desktop.recovery.loadFailed": "QuickCode se nepodařilo načíst",
  "desktop.recovery.terminated": "QuickCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "QuickCode nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.quickcodeMissing": "opencode není v této distribuci nainstalováno",
  "desktop.wsl.error.quickcodeCannotRun": "opencode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QuickCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.quickcode.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.quickcodeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Návštěva ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v QuickCode.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v quickcode.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému QuickCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola QuickCode v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace QuickCode v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace QuickCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode je připraveno v {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte QuickCode do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než QuickCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "QuickCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze QuickCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu QuickCode",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (quickcode.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: QuickCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server QuickCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro QuickCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled QuickCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude QuickCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma QuickCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění QuickCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi QuickCode.",
