export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'QuickCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'QuickCode",
  "desktop.recovery.terminated": "La fenêtre QuickCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "QuickCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'QuickCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.quickcodeMissing": "opencode n'est pas installé dans cette distribution",
  "desktop.wsl.error.quickcodeCannotRun": "opencode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'QuickCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.quickcode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.quickcodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Visitez ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans QuickCode.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans quickcode.json",
  ...
  "dialog.server.description": "Changez le serveur QuickCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'QuickCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'QuickCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour QuickCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode est prêt dans {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez QuickCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'QuickCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "QuickCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'QuickCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe QuickCode",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (quickcode.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'QuickCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "QuickCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur QuickCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour QuickCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'QuickCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si QuickCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'QuickCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'QuickCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'QuickCode.",
