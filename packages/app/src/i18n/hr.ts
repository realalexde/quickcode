...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "QuickCode se nije uspio učitati",
  "Prozor aplikacije QuickCode neočekivano je zatvoren",
  "QuickCode ne reagira",
  ...
  "Instalacija aplikacije QuickCode nije uspjela",
  ...
  "QuickCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije QuickCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.quickcode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.quickcode.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.quickcodeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Posjetiti",
  "provider.connect.quickcodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u QuickCode.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u quickcode.json",
  ...
  "dialog.server.description": "Promijenite na koji se QuickCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera QuickCode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje QuickCode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte QuickCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode je spreman u {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte QuickCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte QuickCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što QuickCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "QuickCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite QuickCode.",
  ...
  "help.tabs.introduction": "Radna površina QuickCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija QuickCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku QuickCode timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (quickcode.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, QuickCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "QuickCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite QuickCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za QuickCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako QuickCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li QuickCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je QuickCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se QuickCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju QuickCode.",
