export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi QuickCode",
  ...
  "desktop.recovery.loadFailed": "QuickCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap QuickCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "QuickCode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan QuickCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.quickcodeMissing": "opencode tidak dipasang dalam distro ini",
  "desktop.wsl.error.quickcodeCannotRun": "opencode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini QuickCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.quickcode.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.quickcodeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Layari",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam QuickCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam quickcode.json",
  ...
  "dialog.server.description": "Tukar pelayan QuickCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak QuickCode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini QuickCode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini QuickCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang QuickCode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum QuickCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "QuickCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu QuickCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan QuickCode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (quickcode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, QuickCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan QuickCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk QuickCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa QuickCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada QuickCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema QuickCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila QuickCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini QuickCode.",
