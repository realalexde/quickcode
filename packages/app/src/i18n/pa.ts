export const dict = {
  ...
  "desktop.menu.documentation": "QuickCode دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "QuickCode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "QuickCode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "QuickCode جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "QuickCode دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.quickcodeMissing": "اس ڈسٹرو وچ opencode انسٹال نئیں اے",
  "desktop.wsl.error.quickcodeCannotRun": "opencode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.quickcodeNotInstalled": "{{distro}} وچ QuickCode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "QuickCode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.quickcode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.quickcode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.quickcodeGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "QuickCode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے QuickCode وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "ویکھو ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے QuickCode وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے QuickCode وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "quickcode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس QuickCode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "QuickCode چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ QuickCode دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "QuickCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ QuickCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ QuickCode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "QuickCode اپ ڈیٹ کرو",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.quickcodeReady": "QuickCode تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ QuickCode انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "QuickCode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QuickCode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "QuickCode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر QuickCode دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "QuickCode Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QuickCode ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع QuickCode ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (quickcode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، QuickCode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "QuickCode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر QuickCode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "QuickCode لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے QuickCode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا QuickCode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "QuickCode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں QuickCode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی QuickCode دا تازہ ترین ورژن چلا رئے او۔",
