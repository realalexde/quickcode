export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja QuickCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać QuickCode",
  "desktop.recovery.terminated": "Okno QuickCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "QuickCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować QuickCode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.quickcodeMissing": "Program opencode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.quickcodeCannotRun": "Program opencode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja QuickCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.quickcode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.quickcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.quickcodeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.quickcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w QuickCode.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku quickcode.json",
  ...
  "dialog.server.description": "Przełącz serwer QuickCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie QuickCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie QuickCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj QuickCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj QuickCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim QuickCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "QuickCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja QuickCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu QuickCode",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (quickcode.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: QuickCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "QuickCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer QuickCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla QuickCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd QuickCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy QuickCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw QuickCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania QuickCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji QuickCode.",
