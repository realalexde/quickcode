...
export const dict = {
  ...
  "dialog.provider.quickcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.quickcode.tagline": "Reliable optimized models",
  "dialog.provider.quickcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in QuickCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.quickcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.quickcodeZen.visit.prefix": "Visit ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in QuickCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in quickcode.json",
  ...
  "dialog.server.description": "Switch which QuickCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking QuickCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating QuickCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update QuickCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode is ready in {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install QuickCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before QuickCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "QuickCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of QuickCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the QuickCode team",
  ...
  "error.chain.checkConfig": "Check your config (quickcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, QuickCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the QuickCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for QuickCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how QuickCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether QuickCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how QuickCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when QuickCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of QuickCode.",
