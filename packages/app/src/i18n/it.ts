export const dict = {
  ...
  "dialog.provider.quickcode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.quickcode.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.quickcodeGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da QuickCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in QuickCode.",
  ...
  "provider.connect.quickcodeZen.line1":
    "QuickCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.quickcodeZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.quickcodeZen.visit.prefix": "Visita ",
  "provider.connect.quickcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.quickcodeZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in QuickCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in QuickCode.",
  ...
  "dialog.plugins.empty": "Plugin configurati in quickcode.json",
  ...
  "dialog.server.description": "Cambia il server QuickCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo QuickCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo QuickCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento QuickCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento QuickCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna QuickCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna QuickCode",
  "wsl.onboarding.quickcodeReadyIn": "QuickCode è pronto in {{distro}}.",
  "wsl.onboarding.quickcodeReady": "QuickCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa QuickCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa QuickCode",
  ...
  "wsl.onboarding.distroStatus.quickcodeMissing": "QuickCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che QuickCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "QuickCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri QuickCode.",
  ...
  "help.tabs.introduction": "QuickCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di QuickCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team QuickCode",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (quickcode.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: QuickCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "QuickCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server QuickCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per QuickCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di QuickCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se QuickCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di QuickCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di QuickCode",
  ...
  "settings.updates.toast.latest.title": "QuickCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di QuickCode.",
  ...
  "desktop.menu.documentation": "Documentazione di QuickCode",
  ...
  "desktop.menu.ariaLabel": "Menu QuickCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare QuickCode",
  "desktop.recovery.terminated": "La finestra di QuickCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "QuickCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di QuickCode non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.quickcodeMissing": "opencode non è installato in questa distribuzione",
  "desktop.wsl.error.quickcodeCannotRun": "opencode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.quickcodeNotInstalled": "QuickCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di QuickCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
