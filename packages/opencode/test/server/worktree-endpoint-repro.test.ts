...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      QUICKCODE_EXPERIMENTAL_WORKSPACES: Flag.QUICKCODE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.QUICKCODE_EXPERIMENTAL_WORKSPACES = original.QUICKCODE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
