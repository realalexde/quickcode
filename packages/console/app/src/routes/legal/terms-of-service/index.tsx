...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>QuickCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="QuickCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to QuickCode. Please read on to learn the rules and restrictions that govern your use of
                QuickCode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("QuickCode," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-opencode">What is QuickCode?</h2>
              <p>
                QuickCode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the QuickCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, QuickCode enables you to
              ...
              <p>
                QuickCode takes the privacy of its users very seriously. For the current QuickCode Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using QuickCode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by QuickCode;
                </li>
                <li>
              ...
              <p>
                If you use QuickCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                QuickCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                QuickCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will QuickCode ever change the Services?</h2>
              <p>
              ...
              <p>
                QuickCode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. QuickCode has the sole right to decide whether you are
              ...
              <p>
                QuickCode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (QuickCode and all such
                parties together, the "QuickCode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the QuickCode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The QuickCode Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the QuickCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without QuickCode's prior written
              ...
              <p>
                ...
                disputes and claims with QuickCode and limits the manner in which you can seek relief from QuickCode. Both
                you and QuickCode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, QuickCode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. QuickCode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. QuickCode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or QuickCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and QuickCode are instead choosing to have claims and disputes resolved by
                ...
                you and QuickCode over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                QuickCode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or QuickCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and QuickCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the QuickCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and QuickCode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and QuickCode, and
                ...
                are not an employee, agent, partner, or joint venture of QuickCode, and you do not have any authority of
                any kind to bind QuickCode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and QuickCode
