...
declare const QUICKCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof QUICKCODE_CLI_NAME === "string" ? QUICKCODE_CLI_NAME : "opencode", {
  description: "QuickCode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
